...
use super::*;
use crate::core::config::{program_workspace_snapshot, workspace_to_tab_configs};
...
impl Engine {
    ...
    /// Mark `projects.yaml` dirty; the write lands after the persistence
    /// debounce (or at app exit) — no per-gesture fsync (issue #62).
