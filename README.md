...
Config and projects changes are persisted with a short debounce — one write
after a burst of UI changes (tab switches, filter edits, zoom notches) instead
of a disk write per gesture, flushed on quit.
